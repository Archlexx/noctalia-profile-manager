...
NBox {
  ...
  NContextMenu {
    ...
    model: [
      ...
      {
        "label": pluginApi?.tr("panel.action-export"),
        "action": "export",
        "icon": "share"
      },
      {
        "label": pluginApi?.tr("panel.action-duplicate"),
        "action": "duplicate",
        "icon": "copy"
      },
      {
    ...
    onTriggered: action => {
                   ...
                   if (action === "overwrite") {
                     ...
                     service?.exportProfile(root.profileName)
                   } else if (action === "duplicate") {
                     service?.duplicateProfile(root.profileName)
